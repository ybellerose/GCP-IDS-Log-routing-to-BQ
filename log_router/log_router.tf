...
resource "google_logging_project_sink" "sink" {
    ...
    # Export to bigquery
    destination = "bigquery.googleapis.com/projects/${var.project_id}/datasets/${var.dataset}"

    # Log all from ids threat and traffic
    filter = "logName:('projects/${var.project_id}/logs/ids.googleapis.com%2Fthreat') OR ('projects/${var.project_id}/logs/ids.googleapis.com%2Ftraffic')"
